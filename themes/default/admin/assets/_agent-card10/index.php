...
<link href="http://member.99newone.com/themes/default/admin/assets/agent-card/css/bootstrap.min.css?v=1" rel="stylesheet">
...
//     $imgData=$_POST['imgDataView2']!=''?$_POST['imgDataView2']:
    $q_user = "update sma_users " . "set seller_id='" . $_POST['yourID'] . "'" . "
            ,img='" . substr($_POST['imgDataView2'], strrpos($_POST['imgDataView2'], '/') + 1) . "'"  // .$imagePath
            ."    , team='".$_POST['team']."'"
...
// $query="select * from sma_users where id=".$_GET['id'];
 $query="select u.*,c.*,u.phone as u_phone,u.seller_id as u_sel_id,u.parent_id as parent_id, u.user_type as user_type, u.default_dealer as default_dealer
 from sma_users u 
...
$privilege_id = isset($user->privilege_id) ? $user->privilege_id : 1;
$getprivilege = "select * from sma_privilege where id=".$privilege_id ;
$privilege = $conn->query($getprivilege)->findOne();
//print_r($privilege);
...
?>
   ...
   <div class="main-page" id ="frm_pic" <?php if(($_POST)){?> style="display :none;"<?php }?>>
				...
				<div class="form-group clearfix p15t">
					<div class="row">
						...
						<div class="col-sm-6 p5t">
							<div style="margin-bottom: 15px;" class="hidden">
								<label>ประเภทสมาชิก<span class="request">*</span></label> 
							...
							?>
								...
								<div class="p20t clearfix">
									<label>ประเภทสมาชิก<span class="request">*</span></label>  <input
										name="typeID" id="typeID" class="form-control" placeholder="" value="<?php echo $privilege->id;?>"
						...
						<?php $team = isset($user->team) ? $user->team : $parent->first_name." ".$parent->last_name; ?>
						<div style="margin-bottom: 15px;" class="">
							<label>TEAM<span class="request">*</span></label> <input  value="<?php echo $team; ?>"
...
-->
				...
				<div class="form-group p20t clearfix">
					<button class="btn btn-action" id="btn-save-data">พรีวิวบัตรตัวแทน</button>
...
<center><button class="btn btn-action" id="btn-edit-data">แก้ไข</button></center>
	<!-- /.main-page -->
  ...
  // ====  save data ==== //
   $("#btn-edit-data").on('click', function () {
			 console.log(113);
// 			 $("#frm_pic:visible");
			 document.getElementById('frm_pic').style.display='';
...
//       document.getElementById('frm_pic').style.visibility='hidden';
   }
...
if ($_POST && $typeID != '') {
    $conn = new connectMySqlDB();
    $strQuery = "SELECT imgTypeUrl FROM sma_privilege WHERE id = '$typeID' ";
    $row = $conn->query($strQuery)->findOne();
    $conn->closeDB();
    $typeAgenDisplay = $row->imgTypeUrl;
	$logo_wisdom = "assets/images/type/logo_wisdom.png";
...
<div style="display:inline-block" class="main-page">
			...
			<div id="container">
              ...
              <!-- Header section-->
				<header class="header">
					<div class="row">
						<div class="col-sm-12">
							<?php $logo = $user->user_type == "wisdom" ? $logo_wisdom : $typeAgenDisplay; ?>
							<img class="logo" title="" alt="" src="<?php print $logo; ?>" />
							<?php 
								if($user->default_dealer == 1){
									$logo_default_dealer = "assets/images/type/logo_dealer.png";
				...
				<div class="main row">
					<div class="col-sm-5" style="width: 207px;float: left;">
						<div class="c-center">
							<div id="avatar">
					...
					<div class="col-sm-7 no-padding" style="width: 320px;float: left;">
						<div id="contact">
							<div class="user_user">
				...
				<footer class="footer">
					<div class="row">
						<div class="col-sm-5" style="width: 207px;float: left;"></div>
            ...
            $("#btn-Convert-Html2Image").on('click', function () {
            	var urlUpload= 'http://member.99newone.com/themes/default/admin/assets/agent-card/upload.php';
				 ...
				 var data = new FormData(document.forms["form1"]);
					data.append("id", '<?php echo $_POST['id']; ?>');
					data.append("team", '<?php echo $team; ?>');
...
//             opener.somefunction(imgName); //or
            ...
            opener.document.getElementById('agent_warn').style.visibility='hidden';
