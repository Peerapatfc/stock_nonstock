     ...
     $('#saveCropImg').click(function(event) {    
      ...
      function uploadImgToServer(){
		  ...
		  if(imgDataFix == "1"){  // === fix site image
           ...
           $('.img-wait-process').html('<img src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/images/ajax-loader.gif">');  
           ...
           setTimeout(function(){  
              $.ajax(urlUpload, {
                ...
                success: function (dataRes) {
                    console.log(dataRes);
                    $('#'+imgDataViewReturn).attr('src', 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/'+ dataRes.result);
                    $('#'+imgDataViewReturn).attr('style','max-width:100px;');
                    $('#imgDataView2').val('http://topagent.smith.in.th/themes/default/admin/assets/agent-card/'+ dataRes.result);
