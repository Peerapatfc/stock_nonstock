...
// $query="select * from sma_users where id=".$_GET['id'];
 $query="select u.*,c.*,u.phone as u_phone from sma_users u left join sma_companies c on u.email=c.email where c.group_name='user' and u.id=".(($_GET['id']!='')?$_GET['id']:$_POST['id']);
                        ...
                        ?>
							...
							<div class="p20t clearfix">
								<label>ID<span class="request">*</span></label> <input
									name="yourID" id="yourID" class="form-control" placeholder="" value="<?php echo $user->seller_id;?>"
...
/*
	...
	<div class="main-page">
		<a id="btn-Convert-Html2Image" href="javascript:;"><button
				class="btn btn-action" id="btn-save-data">ดาวโหลดภาพ</button></a> <br />
