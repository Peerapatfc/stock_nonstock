...
<link href="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/css/bootstrap.min.css?v=1"
	rel="stylesheet">
<link href="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/css/style.css" rel="stylesheet" type="text/css" />
<link href="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/css/cms-process.css" rel="stylesheet" type="text/css" />
<!-- use inw create copper -->
<link href="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/plugins/inw-cropper/css/plugin-cropper.css"
	rel="stylesheet" type="text/css" />
<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/js/jquery.min.js"></script>
<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/js/html2canvas.js"></script>
<script type="text/javascript">  
      var linkUrl = 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/';
    </script>
    <script type="text/javascript">  
      var linkUrl = 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/';
...
//     $imgData=$_POST['imgDataView2']!=''?$_POST['imgDataView2']:
    ...
    ",facebook ='" . $_POST['facebook'] . "'" . ",instragram ='" . $_POST['ig'] . "'" . " where email= '" . $user->email . "'";
...
// $query="select * from sma_users where id=".$_GET['id'];
 $query="select u.*,c.*,u.phone as u_phone,u.seller_id as u_sel_id from sma_users u left join sma_companies c on u.email=c.email where c.group_name='user' and u.id=".(($_GET['id']!='')?$_GET['id']:$_POST['id']);
$user = $conn->query($query)->findOne();
// echo $user->avatar;
if(($user->avatar)!=null||$user->avatar!=''){
    $imagePath="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/images/imgup/tmp/".$user->avatar;
}else{
    $imagePath = 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/images/selimg400x300.jpg';
}
...
?>
		...
		<div class="ui secondary attached segment page-height">
			...
			<form role="form" name="dataFrm" id="dataFrm" class="myFrm" action=""
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-6">
							<label>TEAM<span class="request">*</span></label> <input  value="Example"
  ...
  // ====  save data ==== //
   ...
   $('#btn-clear-data').click(function() {
	...
	<!-- ===== use library ===== -->
	<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/plugins/inw-cropper/js/inwcreate-append.js"></script>
	<div class="clearfix"></div>
	<div id="myModalImg" class="modal fade" role="dialog"
		style="z-index: 99999;"></div>
	<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/plugins/inw-cropper/js/cropper.js"></script>
	<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/plugins/inw-cropper/js/inwcreate-cropimg-fn.js"></script>
	<script type="text/javascript">
              ...
              <!-- Header section-->
				...
				<div class="main row">
					...
					<div class="col-sm-7 no-padding">
						<div id="contact">
							<div class="user_user">
								<p class="input"><?php print $fullName; ?></p>
							</div>
							<div class="user_id">
           ...
           var getTime = '<?php print $getTime; ?>';
            ...
            $("#btn-Convert-Html2Image").on('click', function () {
              ...
              $("#btn-Convert-Html2Image").attr("download", "picture-" + getTime + ".png").attr("href", newData);
            	...
            	var urlUpload= 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/upload.php';
...
//             opener.somefunction(imgName); //or
            opener.document.getElementById('agent_card').src = 'http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/images/imgup/profile/'+ imgName;
            window.close();
         }
...
<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/js/function.apps.js"></script>
<script src="http://topagent.smith.in.th/themes/default/admin/assets/agent-card/assets/plugins/bootstrap/js/bootstrap.min.js?v=61"></script>
