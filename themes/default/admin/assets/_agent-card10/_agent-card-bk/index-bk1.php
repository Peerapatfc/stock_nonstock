...
<link href="assets/plugins/bootstrap/css/bootstrap.min.css?v=1"
	rel="stylesheet">
<link href="css/style.css" rel="stylesheet" type="text/css" />
<link href="css/cms-process.css" rel="stylesheet" type="text/css" />
<!-- use inw create copper -->
<link href="assets/plugins/inw-cropper/css/plugin-cropper.css"
...
?>
  ...
  // ====  save data ==== //
   ...
   $('#btn-clear-data').click(function() {
	...
	<!-- ===== use library ===== -->
	<script src="assets/plugins/inw-cropper/js/inwcreate-append.js"></script>
	<div class="clearfix"></div>
	<div id="myModalImg" class="modal fade" role="dialog"
		style="z-index: 99999;"></div>
	<script src="assets/plugins/inw-cropper/js/cropper.js"></script>
	<script src="assets/plugins/inw-cropper/js/inwcreate-cropimg-fn.js"></script>
	<script type="text/javascript">
              ...
              <!-- Header section-->
				...
				<div class="main row">
					...
					<div class="col-sm-7 no-padding">
						<div id="contact">
							<div class="user_user">
								<p class="input"><?php print $firstName; ?></p>
							</div>
							<div class="user_id">
...
//            element.attr('style','font-size:30pt;');
            function createImg(){
...
// var src = document.getElementById("html-content-holder");
// var img = document.getElementById("previewImage");
// makeHighResScreenshot(src,img, 2); 

                     
                        $("#previewImage").append(canvas);
                        $("#previewImage").attr('opacity','0.1');
                         getCanvas = canvas.toDataURL("image/png");

//                          element.attr('style','font-size:10pt;');
                     }
...
//             var src = document.getElementById("html-content-holder");
//             var img = document.getElementById("previewImage");
//             makeHighResScreenshot(src,img, 198); 
          createImg(); // === create img here ==== //
  </script>
<?php } // ==== End have post  ==== ?> 
<div id="jwProcess"></div>
	<script src="js/function.apps.js"></script>
	<script src="assets/plugins/bootstrap/js/bootstrap.min.js?v=61"></script>
