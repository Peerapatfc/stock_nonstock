                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:120px;"><?= lang("company"); ?></th>
                            <th style="min-width:120px;"><?= lang("name"); ?></th>
                            <th style="min-width:120px;"><?= lang("email_address"); ?></th>
                            <th style="min-width:120px;"><?= lang("phone"); ?></th>
                            <th style="min-width:120px;"><?= lang("city"); ?></th>
                            <th style="min-width:120px;"><?= lang("country"); ?></th>
                            <th style="min-width:180px;"><?= lang("vat_no"); ?></th>
                            <th style="min-width:100px; text-align:center;"><?= lang("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
