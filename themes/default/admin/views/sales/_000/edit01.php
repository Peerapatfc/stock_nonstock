                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input('date_cf_payment', date("d-m-Y", strtotime($inv->date_cf_payment)), 'class="form-control input-tip date"  id="date_cf_payment" required="required"'); ?>
							</div>
							</div>
                            ...
                            <div class="form-group">
								<?= lang("time", "sltime"); ?>
                                <?php echo form_input('time_cf_payment', date("H:i", strtotime($inv->date_cf_payment)), 'class="form-control input-tip time2" data-timepicker="" autocomplete="off" placeholder="__:__"  id="time_cf_payment" required="required"'); ?>
							</div>
							</div>
							</div>
                        </div>
