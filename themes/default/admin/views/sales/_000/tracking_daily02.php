            ...
            <div class="row">
                <div class="col-sm-12">
					<div class="form-group">
						...
						<?php echo form_input('tracking_day', $date, 'class="form-control input-tip date-custom"  id="tracking_day" required="required"   data-bv-notempty-message="'.lang("Enter the correct date").'"'); ?>
					</div>
							<?php
								$txt = '';
								$txt = $date.'</strong><br/>';
			...
			$.ajax({
				...
				data: {
					...
					if(data == false){
						...
						content += "<p><?php echo lang('no_data'); ?></p>";
					}else{
						var i =0; k = 1;
						var txt = '';
						content += "<strong>"+date+"</strong><br/>";
