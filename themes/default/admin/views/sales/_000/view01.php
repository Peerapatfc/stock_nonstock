                ...
                <div class="col-xs-5">
                    ...
                    <div class="col-xs-10">
						...
						if($inv->order_type == "dropship"):
							$_icon = '<i class="fa fa-paper-plane" aria-hidden="true"></i> ';
						else:
							$_icon = '<i class="fa fa-cubes" aria-hidden="true"></i> ';
						endif;
						?>
							<p style="font-weight:bold;"><?= lang("order_type"); ?>: <?= $_icon.lang($inv->order_type); ?></p>
						<?php } ?>
                        <p>&nbsp;</p>
                    </div>
                    <div class="clearfix"></div>
