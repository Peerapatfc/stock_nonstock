    ...
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				$('td:eq(1)', nRow).html('<div class="text-center text-muted"><img style="max-width:32px;" src='+ icon +' /></div>');
            ...
            {column_number: 12, filter_default_label: "[<?=lang('date');?> (dd-mm-yyyy)]", filter_type: "text", data: []},
...
// "Owner-".$this->Owner ."<br/>".
// "Admin-".$this->Admin ."<br/>".
// "view_right-".$this->session->userdata('view_right')."<br/>";
?>
<div class="box">
                ...
                <div class="table-responsive2">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
							...
							<th style="min-width:80px;"><?= lang("chanal"); ?></th>
