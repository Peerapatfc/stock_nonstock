...
.pageheader .icon::before {
   content: "\f055";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('count_stock'); ?></h2>
    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group">
                                <?= form_submit('count_stock', lang("submit"), 'id="count_stock" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
