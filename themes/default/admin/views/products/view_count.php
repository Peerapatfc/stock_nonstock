                ...
                <table class="table table-bordered table-condensed">
                        <tbody>
                            ...
                            <tr>
                                <td><?= lang('files'); ?></td>
                                <td>
                                    <?= anchor('admin/welcome/download/'.$stock_count->initial_file, '<i class="fa fa-download"></i> '.lang('initial_file'), 'class="btn btn-success btn-xs"'); ?>
                                    <?= anchor('admin/welcome/download/'.$stock_count->final_file, '<i class="fa fa-download"></i> '.lang('final_file'), 'class="btn btn-success btn-xs"'); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <?php
                    if ($adjustment) {
                        echo '<a href="'.admin_url('products/view_adjustment/'.$adjustment->id).'" class="btn btn-success btn-block no-print" data-toggle="modal" data-target="#myModal2">'.lang('view_adjustment').'</a>';
                    } elseif (!empty($stock_count_items)) {
                        echo '<a href="'.admin_url('products/add_adjustment/'.$stock_count->id).'" class="btn btn-success btn-block no-print">'.lang('add_adjustment').'</a>';
                    }
                    ?>
                </div>
            </div>
