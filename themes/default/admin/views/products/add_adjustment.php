...
.pageheader .icon::before {
   content: "\f055";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('add_adjustment'); ?></h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_adjustment', lang("submit"), 'id="add_adjustment" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
