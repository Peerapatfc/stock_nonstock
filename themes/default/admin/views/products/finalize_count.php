                    ...
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default download_csv">
                                <div class="panel-body">
                                    <a href="<?= admin_url('welcome/download/'.$stock_count->initial_file); ?>" class="btn btn-success pull-right">
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group">
                                <?= form_submit('stock_count', lang("submit"), 'id="stock_count" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
