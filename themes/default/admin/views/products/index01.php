...
.pageheader .icon::before {
   content: "\f03a";
        ...
        <h2 class="blue"><i
                class="fa-fw fa fa-list"></i><?= lang('products') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'.($supplier ? ' ('.lang('supplier').': '.($supplier->company && $supplier->company != '-' ? $supplier->company : $supplier->name).')' : ''); ?>
        </h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <?php /*?><p class="introtext"><?= lang('list_results'); ?></p><?php */?>
                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:60px; width: 60px; text-align: center;"><?php echo $this->lang->line("image"); ?></th>
                            <th style="min-width:40px;"><?= lang("code") ?></th>
                            <th style="min-width:300px;"><?= lang("name") ?></th>
                            <th style="min-width:40px;"><?= lang("brand") ?></th>
                            <th style="min-width:120px;"><?= lang("category") ?></th>
                            <?php
                            if ($Owner || $Admin) {
                            ...
                            ?>
                            <th style="min-width:30px;"><?= lang("quantity") ?></th>
                            <th style="min-width:90px;"><?= lang("unit") ?></th>
                            <th style="min-width:90px;"><?= lang("rack") ?></th>
                            <th style="min-width:120px;"><?= lang("alert_quantity") ?></th>
