                ...
                <div class="table-responsive2">
                    <table id="STData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:180px" class="col-xs-2"><?= lang("reference") ?></th>
                            <th style="min-width:120px" class="col-xs-2"><?= lang("warehouse") ?></th>
                            <th style="min-width:140px" class="col-xs-1"><?= lang("type") ?></th>
                            <th style="min-width:100px" class="col-xs-2"><?= lang("brands") ?></th>
                            <th style="min-width:140px" class="col-xs-2"><?= lang("categories") ?></th>
