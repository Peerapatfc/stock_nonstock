        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        <?= lang("point_reward", "point_reward") ?>
                        <div class="controls" id="subcat_data"> <?php
                            echo form_input('point_reward', ($product ? $product->point_reward : ''), 'class="form-control" id="point_reward"  placeholder="' . lang("point_reward") . '"');
                            ?>
                        </div>
                    </div>
