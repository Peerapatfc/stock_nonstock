                ...
                <div class="table-responsive2">
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th style="min-width:85px;" class="col-xs-2"><?= lang("date"); ?></th>
                            <th style="min-width:155px;" class="col-xs-2"><?= lang("reference_no"); ?></th>
                            <th style="min-width:155px;" class="col-xs-2"><?= lang("warehouse"); ?></th>
                            <th style="min-width:155px;" class="col-xs-2"><?= lang("created_by"); ?></th>
