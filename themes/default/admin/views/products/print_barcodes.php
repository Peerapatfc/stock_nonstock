...
.pageheader .icon::before {
   content: "\f02a";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('print_barcode_label'); ?></h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="form-group">
                        <?php echo form_submit('print', lang("update"), 'class="btn btn-success"'); ?>
                ...
                <div id="barcode-con">
                    <?php
                        if ($this->input->post('print')) {
                            if (!empty($barcodes)) {
                                echo '<button type="button" onclick="window.print();return false;" class="btn btn-success btn-block tip no-print" title="'.lang('print').'"><i class="icon fa fa-print"></i> '.lang('print').'</button>';
                                $c = 1;
