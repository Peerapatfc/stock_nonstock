...
<div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn btn-xs btn-default no-print pull-right print-hidden" style="margin-right:15px;" onclick="window.print();">
...
<?php if (!$Supplier || !$Customer) { ?>
    <div class="buttons">
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <a href="<?= admin_url('products/print_barcodes/' . $product->id) ?>" class="tip btn btn-success" title="<?= lang('print_barcode_label') ?>">
                    <i class="fa fa-print"></i>
                    <span class="hidden-sm hidden-xs"><?= lang('print_barcode_label') ?></span>
                </a>
            </div>
            <div class="btn-group">
                <a href="<?= admin_url('products/pdf/' . $product->id) ?>" class="tip btn btn-success" title="<?= lang('pdf') ?>">
