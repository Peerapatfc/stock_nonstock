            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="NTTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                        <tr>
                            <th style="min-width: 140px;"><?php echo $this->lang->line("notification"); ?></th>
                            <th style="min-width: 140px;"><?php echo $this->lang->line("submitted_at"); ?></th>
                            <th style="min-width: 140px;"><?php echo $this->lang->line("from"); ?></th>
                            <th style="min-width: 140px;"><?php echo $this->lang->line("till"); ?></th>
                            <th style="min-width:80px;"><?php echo $this->lang->line("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
