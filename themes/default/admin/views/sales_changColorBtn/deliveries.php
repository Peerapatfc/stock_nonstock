        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<ul id="dbTab" class="nav nav-tabs">
					...
					<?php endforeach;*/ ?>
                        <li class=""><a href="#tb_ready"><?= lang('ready') ?><span style="margin-left:3px;background-color: #d9534f;" class="badge badge-warning"><?php echo $countready; ?></span></a></li>
                        <li class=""><a href="#tb_packing"><?= lang('packing') ?><span style="margin-left:3px;background-color: #f0ad4e;" class="badge"><?php echo $countpacking; ?></span></a></li>
                        <li class=""><a href="#tb_delivering"><?= lang('delivering') ?><span style="margin-left:3px;background-color: #428bca;" class="badge"><?php echo $countdelivering; ?></span></a></li>
                        <li class=""><a href="#tb_delivered"><?= lang('delivered') ?><span style="margin-left:3px;background-color: #5cb85c;" class="badge"><?php echo $countdelivered; ?></span></a></li>
                </ul>
