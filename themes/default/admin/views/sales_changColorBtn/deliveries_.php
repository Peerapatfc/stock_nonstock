                ...
                <div id="<?php echo 'tb_'.$key; ?>" class="tab-pane fade in">
					<div class="buttons">
						<div class="btn-group btn-group-justified">
							<div class="btn-group">
							<?php if($key == 'ready'): ?>
								<a style="max-width:200px" href="#" class="tip btn btn-primary" id="print_packing" data-action="print_packing"><i class="fa fa-print" aria-hidden="true"></i> <?= lang('print_packing') ?></a>
