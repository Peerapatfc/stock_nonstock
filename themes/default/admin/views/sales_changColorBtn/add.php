            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="panel-body" style="padding: 5px;">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											echo form_dropdown('order_type', $slorder_type, '', 'class="form-control input-tip" required="required" id="slorder_type"'); ?>
										</div>
									</div>
                                </div>
                            </div>
						...
						<div class="clearfix"></div>
						<div class="col-md-12">
                            <strong><?= lang("payment_confirm"); ?></strong><br>
						</div>
						<div class="col-md-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("bank_from", "slbank_from"); ?>
                                <?php 
                                echo form_dropdown('bank_from', $bank_default, '', 'class="form-control input-tip" required="required" id="slbank_from"'); ?>
                            </div>
                        </div>
						*/ ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input('date_cf_payment', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip date"  id="date_cf_payment" required="required"'); ?>
							</div>
							</div>
                            ...
                            <div class="form-group">
								<?= lang("time", "sltime"); ?>
                                <?php echo form_input('time_cf_payment', (isset($_POST['time']) ? $_POST['time'] : ""), 'class="form-control input-tip time2" data-timepicker="" autocomplete="off" placeholder="__:__"  id="time_cf_payment" required="required"'); ?>
							</div>
							</div>
