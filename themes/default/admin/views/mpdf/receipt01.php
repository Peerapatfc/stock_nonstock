    ...
    <body id="print">
        ...
        <div style="width: 100%;">
            <table style="width: 100%; font-size: 18px; border: 0.5px solid black; border-collapse: collapse;" border="1" cellpadding="5">
                ...
                <tr class="tbSummary">
                    <td class="summary" colspan="2">ค่าจัดส่ง (บาท)</td>
                    <td align="right"><?= $summary['shipping'] ?></td>
                </tr>
                <tr class="tbSummary">
                    <td class="summary" colspan="2">ส่วนลด (บาท)</td>
                ...
                <?php } ?>
                <tr class="tbSummary">
                    <td class="summary" colspan="2">จำนวนเงินรวม (บาท)</td>
                    <td align="right" alt="total"><?= $summary['net_total'] ?></td>
                </tr>
            </table>
        </div>
