...
<html>
    ...
    <body>
        <div style="width: 100%; text-align: right; margin-bottom: 5px;">
            <strong style="font-size: 1.4em;">ต้นฉบับใบส่งของ</strong>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <?php if($header['company']['logo'] != '') { ?>
                            <img src="<?= $header['company']['logo'] ?>" style="height: 100%; max-height: 60px;" />
                        <?php } ?>
                    </div>
        ...
        <div style="width: 100%; margin-bottom: 10px;">
            <table style="width: 100%; font-size: 18px; border: 0.5px solid black; border-collapse: collapse;" border="1" cellpadding="5">
                <tr>
                    ...
                    <th align="center">ส่วนลด<br/>Discount</th>
                ...
                ?>
                    <tr class="tbList" style="border: 0; padding-top: 10px;">
                        ...
                        <td valign="top" align="center"><?= $list['discount'] ?></td>
                ...
                ?>
                <tr class="tbSummary">
                    <td colspan="4" rowspan="5" valign="top">หมายเหตุ:<br/>Remark:</td>
                ...
                <tr class="tbSummary">
                    <td class="summary" colspan="2">ส่วนลด (Discount)</td>
                    <td align="center"><?= $summary['discount'] ?></td>
                </tr>
                <tr class="tbSummary">
                    <td class="summary" colspan="2">ยอดรวม (Total)</td>
        ...
        <div style="width: 100%;">
            <div style="margin: 0 auto; width: 80%;">
                <div style="float: left; width: 30%; text-align: center; border: 1px solid black; border-radius: 1em; padding: 5px;font-size: 18px;">
                ...
                <div style="float: left; width: 30%; text-align: center; border: 1px solid black; border-radius: 1em; padding: 5px; font-size: 18px; margin-left: 9px;">
