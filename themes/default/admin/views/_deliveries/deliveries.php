							...
							<?php if($key == 'ready'): ?>
								<table>
									<tr>
										...
										<td>&nbsp;</td>
										<td>
											<a style="max-width:200px" href="#" class="tip btn btn-danger" id="shippinglabel" data-action="shippinglabel2" data-original-title="<?php echo lang('shippinglabel2'); ?>">
												<i class="fa fa-print" aria-hidden="true"></i> 
												<span><?php echo lang('shippinglabel2'); ?></span>
											</a>
										</td>
									</tr>
								</table>
