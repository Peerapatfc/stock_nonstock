...
.pageheader .icon::before {
   content:"\f02b";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-tag"></i><?= lang('purchases_report'); ?> <?php
            if ($this->input->post('start_date')) {
                ...
                <div class="table-responsive2">
                    <table id="PoRData"
                        ...
                        <tr>
                            ...
                            <th style="min-width:120px;"><?= lang("warehouse"); ?></th>
                            <th style="min-width:120px;"><?= lang("supplier"); ?></th>
                            <th style="min-width:120px;"><?= lang("product_qty"); ?></th>
                            <th style="min-width:120px;"><?= lang("grand_total"); ?></th>
                            <th style="min-width:120px;"><?= lang("paid"); ?></th>
                            <th style="min-width:120px;"><?= lang("balance"); ?></th>
                            <th style="min-width:100px;"><?= lang("status"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
