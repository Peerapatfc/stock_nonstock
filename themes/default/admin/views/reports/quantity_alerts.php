...
.pageheader .icon::before {
   content:"\f1b2";
        ...
        <h2 class="blue"><i
                class="fa-fw fa fa-cube"></i><?= lang('product_quantity_alerts') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="PQData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                        <tr class="active">
                            <th style="min-width85px; width: 40px; text-align: center;"><?php echo $this->lang->line("image"); ?></th>
                            <th style="min-width:150px;"><?php echo $this->lang->line("product_code"); ?></th>
                            <th style="min-width:150px;"><?php echo $this->lang->line("product_name"); ?></th>
                            <th style="min-width:120px;"><?php echo $this->lang->line("quantity"); ?></th>
                            <th style="min-width:120px;"><?php echo $this->lang->line("alert_quantity"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
