...
.pageheader .icon::before {
   content:"\f02c";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-tags"></i><?= lang('expenses_report'); ?> <?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                        <tr class="active">
                            <th style="min-width:100px;" class="col-xs-2"><?= lang("date"); ?></th>
                            <th style="min-width:120px;" class="col-xs-2"><?= lang("reference"); ?></th>
                            <th style="min-width:120px;" class="col-xs-2"><?= lang("category"); ?></th>
                            <th style="min-width:120px;" class="col-xs-1"><?= lang("amount"); ?></th>
                            <th style="min-width:120px;" class="col-xs-3"><?= lang("note"); ?></th>
                            <th style="min-width:120px;" class="col-xs-2"><?= lang("created_by"); ?></th>
