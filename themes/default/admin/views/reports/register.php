...
.pageheader .icon::before {
   content:"\f036";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-align-left"></i><?= lang('register_report'); ?><?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="registerTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                        <tr>
                            <th style="min-width:120px;"><?= lang('open_time'); ?></th>
                            <th style="min-width:120px;"><?= lang('close_time'); ?></th>
                            <th style="min-width:150px;"><?= lang('user'); ?></th>
                            <th style="min-width:120px;"><?= lang('cash_in_hand'); ?></th>
                            <th style="min-width:120px;"><?= lang('cc_slips'); ?></th>
                            <th style="min-width:120px;"><?= lang('Cheques'); ?></th>
                            <th style="min-width:180px;"><?= lang('total_cash'); ?></th>
                            <th style="min-width:190px;"><?= lang('note'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
