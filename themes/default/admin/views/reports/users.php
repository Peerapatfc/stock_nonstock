...
<script>
    $(document).ready(function () {
        oTable = $('#staffTable').dataTable({
            ...
            "aoColumns": [null, null, null, null, null, null, {"mRender": user_status}, {"bSortable": false}]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 0, filter_default_label: "[<?=lang('seller_id');?>]", filter_type: "text", data: []},
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="staffTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                        <tr>
                            <th style="min-width:100px;"><?php echo lang('seller_id'); ?></th>
                            <th style="min-width:100px;"><?php echo lang('first_name'); ?></th>
                            <th style="min-width:100px;"><?php echo lang('last_name'); ?></th>
                            <th style="min-width:100px;"><?php echo lang('email'); ?></th>
                            <th style="min-width:100px;"><?php echo lang('company'); ?></th>
                            <th style="min-width:100px;"><?php echo lang('group'); ?></th>
