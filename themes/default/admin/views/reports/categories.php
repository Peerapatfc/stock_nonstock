...
.pageheader .icon::before {
   content:"\f0e8";
        ...
        <h2 class="blue">
            <i class="fa-fw fa fa-sitemap"></i><?= lang('categories_report'); ?> <?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="PrRData"
                        ...
                        <thead>
                        <tr class="active">
                            <th style="min-width:150px;"><?= lang("category_code"); ?></th>
                            <th style="min-width:150px;"><?= lang("category_name"); ?></th>
                            <th style="min-width:150px;"><?= lang("purchased"); ?></th>
                            <th style="min-width:150px;"><?= lang("sold"); ?></th>
                            <th style="min-width:150px;"><?= lang("purchased_amount"); ?></th>
                            <th style="min-width:150px;"><?= lang("sold_amount"); ?></th>
                            <th style="min-width:150px;"><?= lang("profit_loss"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
