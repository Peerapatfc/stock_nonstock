                ...
                <div class="table-responsive2">
                    <table id="PayRData"
                        ...
                        <tr>
                            ...
                            <th style="min-width:150px;"><?= lang("payment_ref"); ?></th>
                            <th style="min-width:150px;"><?= lang("sale_ref"); ?></th>
                            <th style="min-width:150px;"><?= lang("purchase_ref"); ?></th>
                            <th style="min-width:120px;"><?= lang("paid_by"); ?></th>
                            <th style="min-width:100px;"><?= lang("amount"); ?></th>
                            <th style="min-width:100px;"><?= lang("type"); ?></th>
                            <th style="min-width:85px;"><?= lang("id"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
