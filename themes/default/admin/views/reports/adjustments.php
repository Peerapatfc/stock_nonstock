            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="dmpData" class="table table-bordered table-condensed table-hover table-striped">
                        <thead>
                        <tr>
                            <th style="min-width:150px;" class="col-xs-2"><?= lang("date"); ?></th>
                            <th style="min-width:150px;" class="col-xs-2"><?= lang("reference_no"); ?></th>
                            <th style="min-width:150px;" class="col-xs-2"><?= lang("warehouse"); ?></th>
                            <th style="min-width:150px;" class="col-xs-1"><?= lang("created_by"); ?></th>
                            <th style="min-width:190px;"><?= lang("note"); ?></th>
                            <th style="min-width:250px;" class="col-xs-2"><?= lang('products'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
