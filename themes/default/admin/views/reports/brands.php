...
.pageheader .icon::before {
   content:"\f00b";
        ...
        <h2 class="blue">
            <i class="fa-fw fa fa-th-list"></i><?= lang('brands_report'); ?> <?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive2">
                    <table id="PrRData"
                        ...
                        <thead>
                        <tr class="active">
                            <th style="min-width:150px;"><?= lang("brand"); ?></th>
                            <th style="min-width:120px;"><?= lang("purchased"); ?></th>
                            <th style="min-width:120px;"><?= lang("sold"); ?></th>
                            <th style="min-width:120px;"><?= lang("purchased_amount"); ?></th>
