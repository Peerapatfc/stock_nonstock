...
.pageheader .icon::before {
   content:"\f1b3";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-cubes"></i><?= lang('products_report'); ?> <?php
            if ($this->input->post('start_date')) {
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="PrRData"
                        ...
                        <thead>
                        <tr class="active">
                            <th style="min-width:150px;"><?= lang("product_code"); ?></th>
                            ...
                            <th style="min-width:150px;"><?= lang("stock_in_hand"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
