...
<div class="row">
    ...
    <div class="col-sm-10">
        <ul id="myTab" class="nav nav-tabs">
            ...
            <li class=""><a href="#edit" class="tab-grey"><i class="glyphicon glyphicon-edit"></i> <?= lang('edit') ?></a></li>
			
			<?php if($user->group_id != "13"): ?>
            <li class=""><a href="#cpassword" class="tab-grey"><i class="fa fa-key"></i> <?= lang('change_password') ?></a></li>
            <li class=""><a href="#avatar" class="tab-grey"><i class="glyphicon glyphicon-user"></i> <?= lang('avatar') ?></a></li>
            <li class=""><a href="#document" class="tab-grey"><i class="glyphicon glyphicon-file"></i> <?= lang('document') ?></a></li>
			<?php endif; ?>
			
			<!-- <li class=""><a href="#parent" class="tab-grey"><i class="fa fa-user-plus"></i> <?= lang('parent') ?></a></li>
			<?php if($Settings->wallet_use=="1"): ?><li class=""><a href="#wallet" class="tab-grey"><?= lang('wallet') ?></a></li><?php endif; ?> -->


			<?php if($user->group_id != "13"): ?>
			<?php if($this->Settings->award_use){ ?>
				<li class=""><a href="#awardpoints" class="tab-grey"> <i class="fa fa-trophy"></i> <?= lang('award_points') ?></a></li><?php  } ?>
			<?php endif; ?>
								...
								<div class="row">
									...
									<ul id="dbTab" class="nav nav-tabs tab_delivering">
										<?php foreach($attr as $key => $value): ?>
											<?php 
											if($value=="Silver"){ 
												$point_tab_title = "Pureplus Bonus 1"; 
											}else if($value=="Gold"){
												$point_tab_title = "Pureplus Bonus 2"; 
											} 
											?>
											<li class=""><a href="#<?php echo $value.'_'.$key; ?>"><?= lang($point_tab_title); ?></a></li>
										<?php endforeach; ?>
									</ul>
            ...
            <div id="edit" class="tab-pane fade in">
                <div class="box">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <?php $attrib = array('id' => 'edit_user' ,'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
									...
									<?php
										...
										?>
											...
											<div class="form-group1 hidden">
												<?= lang("team", "team"); ?>
												<?php echo form_input('team', $user->team, 'class="form-control" id="team" '); ?>
											</div>
								...
								<?php 
/* case1
ค่าที่คลิกมาจาก หน้ารายการ user ต้อง ไม่เท่ากับ คนที่ login
case 2 
ข้อมูลแม่ทีม คือคนที่ login หรือไม่ หรือคนที่ทำรายการหรือไม่
case 3 
คนที่ login เป็น wisler หรือไม่  */								
								if($id_get!=$this->session->userdata('user_id')&&$momparent==$this->session->userdata('user_id')&&$id_group==7){ ?>
						...
						<?php } ?>
									...
									<?php #echo CI_VERSION; ?>
                                            ...
                                            <?php //} ?>
											<?php echo form_hidden('form_action', ""); ?>
                                ...
                                <p><?php //echo form_submit('update', lang('update'), 'class="btn btn-success btn-margin-top"'); ?></p>
											...
											<div class="col-md-3">
											<a class="submit-form" href="#" action="update"><div class="btn btn btn-block btn-success btn-margin-top"><i class="fa fa-check-square"></i> <?= lang('update'); ?></div></a>
											<?php /*echo form_submit('update', lang('update'), 'class="btn btn btn-block btn-success btn-margin-top"');*/ ?>
											</div>



											<div class="col-md-3">
											<?php /*echo form_submit('ceate crad', lang('ceate crad'), 'class="btn btn btn-block btn-success btn-margin-top"');*/ ?>
											<a class="submit-form" href="#" action="create-card"><div class="btn btn btn-block btn-success btn-margin-top"><i class="fa fa-user"></i> <?= lang('create_dealer_card'); ?></div></a>
											</div>
                                            			<script>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-md-5">
                                	...
                                	<p style="color: red; font-size: 15px;">*รูปภาพควรเป็นสี่เหลี่ยมจตุรัส</p>
                                    ...
                                    <div style="position: relative;">
                                        <?php if ($user->avatar) { ?>
                                            ...
                                            <a href="<?= admin_url('auth/delete_avatar/' . $id . '/' . $user->avatar) ?>" class="btn btn-danger " style="position: absolute; top: 0;" title="<?= lang('delete_avatar') ?>"><i class="fa fa-trash-o"></i></a><br>
						...
						<div class="row" style="padding:10px;">
							<div class="col-sm-5">
								...
								echo admin_form_open_multipart("auth/id_card", $attrib); ?>
                                            ...
                                            <?php echo form_input($user_id); ?>
                                            <p><?php echo form_submit('save', lang('save_cardID'), 'class="btn btn-success"'); ?></p>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
                </div>
						...
						<div class="row" style="padding:10px;">
							<div class="col-sm-5">
								...
								echo admin_form_open_multipart("auth/account_book", $attrib); ?>
                                            ...
                                            <?php echo form_input($user_id); ?>
                                            <p><?php echo form_submit('save', lang('save_account_book'), 'class="btn btn-success"'); ?></p>
					...
					<div class="box-content">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-5">
									<div class="row">
									<div id="" class="col-sm-12 col-xs-12 col-md-9">
									<div class="form-group">
									...
									<?php 
										...
										<div id="popover-div" class="col-sm-12 col-xs-12 col-md-9">
											<?php /*<a title="" class="btn btn-primary change-trigger" href="javascript:;" data-original-title="<?php echo lang('join_the_team') ?>" aria-describedby="popover589460"><?php echo lang('join_the_team') ?></a>*/ ?>
											
											<div class="hide01" id="html-div">
													<p style="margin: 15px 0 0;" class="text-primary"><?php echo lang("please_fill_in_the_correct_answer."); ?></p>
													<label id="captchaText"></label>
													<div class="form-group">
														<input id="captchaInput" class="form-control" placeholder="<?php lang('result'); ?>" type="text">
													</div>
													<div class="form-group">
													<p><?php echo form_submit('update_parent', lang('join_the_team'), 'id="btn_update_parent" class="btn btn-success"'); ?></p>
									...
									$(document).ready(function(){
										...
										// $('.change-trigger').popover({
											// placement : 'right',
											// title : '<?php echo lang("update_parent"); ?>',
											// trigger : 'click',
											// container: 'body',
											// html : true,
											// content : function(){
										...
										var submit = $("#update_parent").find('input[type=submit]');
										submit.attr('disabled', 'disabled');
										// Generate random numbers and the sum of them
										var rndmNr1 = Math.floor(Math.random() * 10),
											rndmNr2 = Math.floor(Math.random() * 10),
											totalNr = rndmNr1 + rndmNr2;
											$("#captchaText").text(rndmNr1 + ' + ' + rndmNr2 + ' = ?');
											
											$("#captchaInput").keyup(function(){
													if ($(this).val() == totalNr)
														submit.removeAttr('disabled').addClass("act");
													else
														submit.attr('disabled', 'disabled').removeClass("act");
											});
									});
									</script>
