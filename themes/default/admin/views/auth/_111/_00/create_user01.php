                        ...
                        <div class="col-md-5 col-md-offset-1">
							...
							<div class="row">
								<div class="no">
												...
												<div class="panel-body">
													<div class="row">
														<div class="col-xs-12 col-sm-12">
															<input type="radio" class="checkbox type" value="1" name="type" id="Non_stock" <?= $this->input->post('type') ? 'checked="checked"' : ''; ?> required="required">
															<label for="full" class="padding05">
																<?= lang('Non_stock'); ?>
															</label>
														</div>
														<div class="col-xs-12 col-sm-12">
															<input type="radio" class="checkbox type" value="2" name="type" id="Stock_Item" <?= $this->input->post('type') ? 'checked="checked"' : ''; ?>>
														...
														<div class="col-xs-12 col-sm-12">
															<input type="radio" class="checkbox type" value="3" name="type" id="Stock_Model" <?= $this->input->post('type') ? 'checked="checked"' : ''; ?>>
															<label for="partial" class="padding05">
									...
									<div class="panel panel-warning">
                                        <div class="panel-heading"><?= lang('agent') ?></div>
										<div class="panel-body" style="padding: 5px;">
											<div class="col-md-12">
												<div class="col-md-12">
												<div class="controls">
												<div class="form-group">
													<input name="agent" type="checkbox" class="checkbox" id="agent" value="1" />
													<label for="agent" class="padding05"><?= lang('agent') ?></label>
												</div>
												</div>
												</div>
											</div>
