			...
			<div class="container-reg">
				<div class="row">
					<div id="content" class="col-sm-12 full">
						<div class="header">
							<p style="font-weight: bold; color: black; font-size: 50px;">PUREPLUS</p>
						...
						<div class="row">
							...
							<div class="login-box">
										...
										<div class="col-md-12">
											<div class="col-content">
												...
												<div class="form-group">
													...
													<h4 style="background-color: rgba(28,175,154,.2);padding: 6px 12px;margin-top: 0;border-radius: 4px;border: 1px solid rgba(28,175,154,.5);"><?php echo $parent_name; ?></h4>
													<?php echo form_input('id_advisor', $parentid, 'class="form-control hidden" id="id_advisor"'); ?>
												</div>
												...
												<?= lang("line", "line"); ?>
													<div class="controls">
													<?php echo form_input('line', '', 'class="form-control" id="line" required="required"'); ?>
													</div>
												</div>

												<div class="form-group">
												<?= lang("facebook", "facebook"); ?>
												<?php echo form_input('facebook', '', 'class="form-control" id="facebook" required="required"'); ?>
												</div>

												<div class="form-group">
												<?= lang("Instragram", "Instragram"); ?>
												<?php echo form_input('instragram', '', 'class="form-control" id="instragram" required="required"'); ?>
												</div>
								...
								<?php 
									...
									echo '<br/><br/><a style=" font-weight:  bold;text-decoration: underline;" href="'.base_url().'" class="col-xs-12 back_to_login">'.lang('login').'</a>';
								endif; 
								?>
