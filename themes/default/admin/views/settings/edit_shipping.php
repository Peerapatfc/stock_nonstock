...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_shipping'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
		
        echo admin_form_open_multipart("system_settings/edit_shipping/", $attrib); ?>
        <div class="modal-body">
			...
			<div class="form-group">
				...
				echo form_dropdown('condition_name', $condition_name, $shipping->condition_name, 'class="form-control input-tip" required="required" id="condition_name"'); ?>
			</div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_shipping', lang('edit_shipping'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
