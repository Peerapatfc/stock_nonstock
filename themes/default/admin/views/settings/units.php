...
.pageheader .icon::before {
    content: "\f1b2";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-cube"></i><?= lang('units'); ?></h2>
                    ...
                    <table id="UnitTable" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th  style="min-width:120px;"><?= lang("unit_code"); ?></th>
                                <th style="min-width:160px;"><?= lang("unit_name"); ?></th>
                                <th style="min-width:85px;"><?= lang("base_unit"); ?></th>
                                <th style="min-width:140px;"><?= lang("operator"); ?></th>
                                <th style="min-width:120px;"><?= lang("operation_value"); ?></th>
