                ...
                <div class="table-responsive2">
                    <table id="CURData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th style="min-width:110px;"><?= lang("currency_code"); ?></th>
                            <th style="min-width:120px;"><?= lang("currency_name"); ?></th>
                            <th style="min-width:130px;"><?= lang("exchange_rate"); ?></th>
                            <th style="min-width:85px;"><?= lang("symbol"); ?></th>
