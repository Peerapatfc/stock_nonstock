            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-6 <?php if($vi == 1) echo "hidden" ?>">
                                        <div class="form-group">
                                            <?= lang("customer", "slcustomer"); ?>
                                            <div class="input-group">
                                                <?php
                                                echo form_input('customer', (isset($_POST['customer']) ? $_POST['customer'] : $customerid), 'id="slcustomer" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                                ?>
									...
									<div class="col-sm-6 <?php if($vi == 1 || $vi == 2) echo "hidden" ?>">
										<div class="form-group">
											...
											<?php 
											$slorder_type = array('stock' => lang('stock'), 'dropship' => lang('dropship'));
						...
						<div style="margin-top:15px;margin-bottom: 5px;" class="col-md-12">
                            <span><?= lang("payment_confirm"); ?></span><br>
						</div>
						<div class="col-md-12">
						<div class="well cleartl" style="display: inline-block;width: 100%;">
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_sale', lang("submit"), 'id="add_sale" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		function shippingtitle(){
			var item = jQuery('#slTable #tfoot th:nth-child(2)').html();
			var price = jQuery('#slTable #tfoot th:nth-child(3)').html();
		   ...
		   try {
				...
				// if( is_low <= is_type && is_type <= is_high){
					// jQuery('#slshipping').val(is_price);
				// }else{
					// jQuery('#slshipping').val(0);
				// }
				...
				var condition_data = {
					is_type: "kerry",
					is_condition : "price",
					is_dondition_value : "1000",
				};
				
				$.ajax({
					type: "POST", 
					url: site.base_url + "system_settings/shipping",
					data: condition_data,
