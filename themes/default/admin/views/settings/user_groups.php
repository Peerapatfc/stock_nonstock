...
.pageheader .icon::before {
    content: "\f084";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-key"></i><?= lang('groups'); ?></h2>
                ...
                <div class="table-responsive2">
                    <table id="GPData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th style="min-width:190px;"><?php echo $this->lang->line("group_id"); ?></th>
                            <th style="min-width:100px;"><?php echo $this->lang->line("group_name"); ?></th>
                            <th style="min-width:180px;"><?php echo $this->lang->line("group_description"); ?></th>
                            <th style="min-width:85px;"><?php echo $this->lang->line("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
