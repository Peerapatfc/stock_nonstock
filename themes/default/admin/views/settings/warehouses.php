...
.pageheader .icon::before {
    content: "\f1b3";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-cubes"></i><?= $page_title ?></h2>
                ...
                <div class="table-responsive2">
                    <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th style="min-width:160px;" class="col-xs-1"><?= lang("code"); ?></th>
                            <th style="min-width:160px;" class="col-xs-2"><?= lang("name"); ?></th>
                            <th style="min-width:100px;" class="col-xs-2"><?= lang("price_group"); ?></th>
                            <th style="min-width:120px;" class="col-xs-2"><?= lang("phone"); ?></th>
                            <th style="min-width:140px;" class="col-xs-2"><?= lang("email"); ?></th>
                            <th style="min-width:180px;" class="col-xs-3"><?= lang("address"); ?></th>
