...
.pageheader .icon::before {
    content:"\f0e8";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-sitemap"></i><?= lang('categories'); ?></h2>
                    ...
                    <table id="CategoryTable" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width:100px; width: 40px; text-align: center;">
                                    <?= lang("image"); ?>
                                </th>
                                <th style="min-width:100px;"><?= lang("category_code"); ?></th>
                                <th style="min-width:160px;"><?= lang("category_name"); ?></th>
                                <th style="min-width:100px;"><?= lang("slug"); ?></th>
                                <th style="min-width:150px;"><?= lang("parent_category"); ?></th>
