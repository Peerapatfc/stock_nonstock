...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
		...
		<?php if($max_limit){ ?>
			<div class="alert alert-danger"><?php echo lang("your_biller_has_maximum_limits_").$limitbybiller; ?></div>
		<?php } ?>
        ...
        <div class="modal-footer">
            <?php if(!$max_limit) echo form_submit('add_biller', lang('add_biller'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
