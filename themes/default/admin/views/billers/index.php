...
<script>
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            {column_number: 1, filter_default_label: "[<?=lang('code_billers');?>]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?=lang('name_lastname');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:180px"><?= lang("code_billers"); ?></th>
                            <th style="min-width:180px"><?= lang("name_lastname"); ?></th>
                            <th style="min-width:180px"><?= lang("vat_no"); ?></th>
                            <th><?= lang("phone"); ?></th>
                            <th><?= lang("email_address"); ?></th>
                            <th style="min-width:100px"><?= lang("city"); ?></th>
                            <th><?= lang("country"); ?></th>
