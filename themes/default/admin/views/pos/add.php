                                ...
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                        ...
                                        <div class="btn-group btn-group-justified pos-grid-nav">
                                            <div class="btn-group">
                                                <button style="z-index:10002;" class="btn btn-success pos-tip" title="<?=lang('previous')?>" type="button" id="previous">
                                                    <i class="fa fa-chevron-left"></i>
                                                </button>
                                            </div>
                                            <?php if ($Owner || $Admin || $GP['sales-add_gift_card']) {?>
                                            <div class="btn-group">
                                                <button style="z-index:10003;" class="btn btn-success pos-tip" type="button" id="sellGiftCard" title="<?=lang('sell_gift_card')?>">
                                            ...
                                            ?>
                                            <div class="btn-group">
                                                <button style="z-index:10004;" class="btn btn-success pos-tip" title="<?=lang('next')?>" type="button" id="next">
...
<div class="rotate btn-cat-con">
    ...
    <button type="button" id="open-category" class="btn btn-success open-category"><?= lang('categories'); ?></button>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        ...
                        <button type="button" class="btn btn-success col-md-12 addButton"><i
            ...
            <div class="modal-footer">
                <button class="btn btn-block btn-lg btn-success" id="submit-sale"><?=lang('submit');?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal" id="cmModal" tabindex="-1" role="dialog" aria-labelledby="cmModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="editComment"><?=lang('submit')?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade in" id="dsModal" tabindex="-1" role="dialog" aria-labelledby="dsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="updateOrderDiscount" class="btn btn-success"><?=lang('update')?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade in" id="sModal" tabindex="-1" role="dialog" aria-labelledby="sModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="updateShipping" class="btn btn-success"><?=lang('update')?></button>
            </div>
        </div>
    </div>
</div>
...
?>
            ...
            <div class="modal-footer">
                <button type="button" id="updateOrderTax" class="btn btn-success"><?=lang('update')?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade in" id="susModal" tabindex="-1" role="dialog" aria-labelledby="susModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="suspend_sale" class="btn btn-success"><?=lang('submit')?></button>
            </div>
        </div>
    </div>
</div>
