    ...
    $(document).ready(function () {
        oTable = $('#POSData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				//$('td:eq(7)', nRow).html('<div class="text-right">'+ parseFloat(aData[5] - aData[6]) +'</div>' );
...
<div class="box">
	...
	.pageheader .icon::before {
        ...
        <h2 class="blue"><i
                class="fa-fw fa fa-cube"></i><?= lang('pos_sales') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
                ...
                <div class="table-responsive2">
                    <table id="POSData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th class="thsale_status"><?= lang("grand_total"); ?></th>
                            <th class="thsale_status"><?= lang("paid"); ?></th>
                            <th class="thsale_status"><?= lang("balance"); ?></th>
