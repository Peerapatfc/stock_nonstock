...
.pageheader .icon::before {
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 beginaddsale">
			<a class="btn btn-danger begin-addsale" href="<?=admin_url('sales/tracking_daily')?>" data-toggle="modal" data-target="#myModal" class="tip" title="" data-original-title="<?=lang('tracking_daily')?>"><i class="glyphicon glyphicon-bullhorn"></i> <?=lang('tracking_daily')?></a>
