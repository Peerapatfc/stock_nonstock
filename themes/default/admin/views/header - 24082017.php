...
<section>
  <div class="leftpanel">
    <div class="logopanel">
        <h1><a class="navbar-brand-renew" href="<?= admin_url() ?>"><span class="logo"><?= $Settings->site_name ?></span></a></h1>
    </div><!-- logopanel -->
    ...
    <div class="leftpanelinner">    
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket mb30">
              ...
              <li><a href="<?= admin_url('users/profile/' . $this->session->userdata('user_id') . '/#cpassword'); ?>"><i class="fa fa-key"></i> <span><?= lang('change_password'); ?></span></a></li>
                        ...
                        if ($Owner || $Admin) {
                            ?>
                             ...
                             <li class="nav-parent mm_sales  <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul class="children">
                                    <li id="sales_index"><?php //echo  $csale ?>
                        ...
                        <?php
                            ...
                            <li class="nav-parent mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul class="children">
                                    ...
                                    <li id="pos_sales">
                                        <a class="submenu" href="<?= admin_url('pos/sales'); ?>">
                                            <i class="fa fa-cube"></i><span class="text"> <?= lang('pos_sales'); ?></span>
                                        </a>
                                    </li>
                                    <?php } */?>
                                    <?php if ($GP['sales-add']) { ?>
                            ...
                            <li class="mm_quotes">
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('quotes'); ?>">
                                            <i class="fa fa-list"></i><span class="text"> <?= lang('list_quotes'); ?></span>
                                        </a>
                                    </li>
  ...
  <div class="mainpanel">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu dropdown-menu-head pull-right">
                ...
                <li class="language">
                    ...
                    <div class="desc">
                      <h5><a href="<?= admin_url('welcome/toggle_rtl') ?>">
                       <i class="fa fa-align-<?=$Settings->user_rtl ? 'right' : 'left';?>"></i>
                       <?= lang('toggle_alignment') ?></a></h5>
                    </div>
                </li>
				*/ ?>
    ...
    <div class="panel panel-default" id="container">
        ...
        <table class="lt"><tr>
            ...
            <div id="content00" class="panel-body panel-body-nopadding">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($message) { ?>
...
<!--
<script src="<?= $assets ?>js/templatejs/js/jquery-1.11.1.min.js"></script>
<script src="<?= $assets ?>js/templatejs/js/jquery-migrate-1.2.1.min.js"></script>-->
