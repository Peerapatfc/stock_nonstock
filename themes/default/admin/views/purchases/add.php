...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		localStorage.setItem('posupplier', '<?= $setting->supplier ?>'); //custom
        <?php if ($Owner || $Admin) { ?>
        if (!localStorage.getItem('podate')) {
...
.pageheader .icon::before {
   content:"\f055";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('add_purchase'); ?></h2>
    </div>
                ...
                <div class="row">
					...
					<?php #echo $setting->supplier; ?>
                        ...
                        <div style="display:none;" class="col-md-12">
                            <div class="panel panel-warning btn-margin-top">
                        ...
                        <div class="col-md-12">
                            <div
                                class="from-group"><?php echo form_submit('add_pruchase', $this->lang->line("submit"), 'id="add_pruchase" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <?php /* <td><?= lang('total') ?> <span class="totals_val pull-right" id="total">0.00</span></td>
                ...
                $.ajax({
                    ...
                    success: function (data) {
						...
						if(data[0].price == 'null'){
							...
							var gtotal = ((total + invoice_tax)) + shipping;
