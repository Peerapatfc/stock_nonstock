...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("purchases/add_delivery/".$inv->id, $attrib); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('address', $address, 'class="form-control" id="address" required="required"'); ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php echo form_input('customer', $customer, 'class="form-control" id="customer" required="required" '); ?>
                    </div>

                    <div class="form-group hidden">
                        <?= lang('status', 'status'); ?>
                        <?php
                        $opts = array('ready' => lang('Ready Ship'), 'packing' => lang('packing'), 'delivering' => lang('delivering'), 'delivered' => lang('delivered'));
                        ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_delivery', lang('add_delivery'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
