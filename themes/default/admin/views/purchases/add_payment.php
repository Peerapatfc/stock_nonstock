...
<div id="add_payment" class="modal-dialog">
    <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('reference_no', (isset($inv->reference_no) ? $inv->reference_no : $payment_ref), 'class="form-control tip" id="reference_no"'); ?>
                    </div>
                </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_payment', lang('add_payment'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
