                ...
                <div class="table-responsive2">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th  style="min-width:120px;" class="col-xs-2"><?= lang("date"); ?></th>
                            ...
                            <th style="min-width:190px;" class="col-xs-3"><?= lang("note"); ?></th>
                            <th style="min-width:140px;" class="col-xs-2"><?= lang("created_by"); ?></th>
