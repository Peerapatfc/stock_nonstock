...
<div class="modal-dialog" id="slip-attachment">
    <div class="modal-content">
        ...
        <div class="modal-footer col-center">
			<?php if($show > 0): ?>
			<a id="view_add_payment" class="btn btn-danger" href="<?php echo admin_url('purchases/add_payment/'.$id); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-money"></i> <?php echo lang("confirm payment"); ?></a>
			<?php endif; ?>
		</div>
		</div>
