    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form2">
                    <?php echo admin_form_open("purchases/index"); ?>
					
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="controls"><?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : ""), 'placeholder="'.lang("start_date").'" class="form-control datetime date_c" id="start_date"'); ?></div>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="controls"><?php echo form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] : ""), 'placeholder="'.lang("end_date").'" class="form-control datetime date_c" id="end_date"'); ?></div>
                            </div>
                        </div>
						<div class="col-sm-3">
							<div class="form-group">
								<div class="controls"> <?php echo form_submit('search', $this->lang->line("search"), 'class="btn btn-primary"'); ?> </div>
							</div>
						</div>
                    </div>
