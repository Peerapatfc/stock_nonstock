...
.pageheader .icon::before {
   content:"\f055";
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('add_purchase_by_csv'); ?></h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm btn-margin-top">
                            <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_purchase_products.csv"
                               class="btn btn-success pull-right"><i class="fa fa-download"></i> Download Sample
                                File</a>
                    ...
                    <div class="col-md-12">
                        <div
                            class="from-group"><?php echo form_submit('add_pruchase', $this->lang->line("submit"), 'id="add_pruchase" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?></div>
                    </div>
                </div>
            </div>
