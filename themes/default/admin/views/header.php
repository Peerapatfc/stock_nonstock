...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-119228207-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-119228207-3');
</script>
</head>
...
<section>
  <div class="leftpanel">
    <div class="logopanel">
        <h1><a class="navbar-brand-renew" href="<?= admin_url() ?>"><span class="logo"><img title="Agent Smith" alt="Agent Smith" src="<?php echo base_url().'assets/uploads/logos/Logo-SMITH1.png'; ?>" /></span></a></h1>
    </div><!-- logopanel -->
...
<div class="leftpanelinner">    
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
                        ...
                        if ($Owner || $Admin) {
							...
							<li id="reports_payments" class="mm_reports_payments">
							...
							<li class="nav-parent mm_reports">
                                ...
                                <ul class="children">
                                    <li id="reports_orderprovince">
                                        <a href="<?= admin_url('reports/orderprovince') ?>">
                                            <i class="glyphicon glyphicon-map-marker"></i><span class="text"> <?= lang('order_province'); ?></span>
                                        </a>
                                    </li>
								
                                    <li id="reports_daily_report">
                                        <a href="<?= admin_url('reports/daily_report') ?>">
                                            <i class="fa fa-signal"></i><span class="text"> <?= lang('daily_report'); ?></span>
                                        </a>
                                    </li>
								
								<?php /*
                                    <li id="reports_user_report">
                                        <a href="<?= admin_url('reports/user_report') ?>">
                                            <i class="fa fa-bar-chart-o"></i><span class="text"> <?= lang('user_report'); ?></span>
                                        </a>
                                    </li>
								*/ ?>
                                    <li id="reports_index">
							...
							<!-- product transfers -->
							 <li class="nav-parent mm_transfers mm_system_settings_warehouses">
                                <a class="" href="#">
                                    <i class="fa fa-cubes"></i>
							...
							<li class="mm_list_customers mm_customers nav-parent">
							...
							<!-- list_users -->
							<?php if ($Owner) { ?>
							<li class="mm_list_users mm_auth nav-parent">
                                    <a class="submenu" href="#">
										<i class="fa fa-users"></i><span class="text"> <?= lang('account_users'); ?></span>
									</a>
									<ul class="children">	
										<li id="auth_users">
							...
							<!-- mm_billers -->
                            <?php /*<li class="nav-parent mm_billers">
                                <a class="" href="#">
							...
							<!-- list_suppliers -->
							 <li class=" mm_suppliers nav-parent">
                                        <a class="submenu" href="#">
                            ...
                            <?php if ($Owner) { ?>
                                <li class="nav-parent mm_banktransfer mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    <a class="" href="#">
                                    ...
                                    <ul class="children">
										...
										<li id="pointreward_index">
											<a class="submenu" href="<?= admin_url('award_points/add'); ?>" data-toggle="modal" data-target="#myModal">
												<i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_award_points'); ?></span>
											</a>
										</li>
										
										
                                        <li id="system_settings_shipping_matrixrate">
                                            <a href="<?= admin_url('award_points') ?>">
                                                <i class="fa fa-gift" aria-hidden="true"></i><span class="text"> <?= lang('award_points'); ?></span>
                                            </a>
                                        </li>
										
                                        <li id="system_settings_shipping_matrixrate">
                                            <a href="<?= admin_url('award_points/approve') ?>">
                                                <i class="fa fa-gift" aria-hidden="true"></i><span class="text"> <?= lang('approve_award_points'); ?></span>
                                            </a>
                                        </li>
                                        ...
                                        <li id="system_settings_shipping_matrixrate">
										 ...
										 <li id="system_settings_shipping_matrixrate">
                                            <a href="<?= admin_url('wallets') ?>">
                                                <i class="fa fa-money" aria-hidden="true"></i><span class="text"> <?= lang('approve_wallet'); ?></span>
                                            </a>
                                        </li>
										
                                        <li id="system_settings_commission">
                                        ...
                                        <li id="system_settings_currencies">
                                         ...
                                         <li id="banktransfer_index">
                                            <a  href="<?= admin_url('banktransfer'); ?>">
                        ...
                        <?php
                            ...
                            <li class="nav-parent mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul class="children">
                                    ...
                                    <li id="sales_add">
                                        <a class="submenu" href="<?= admin_url('sales/add'); ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_order'); ?></span>
                                        </a>
                                    </li>
                                    <?php } ?>
                                </ul>
                            ...
                            <?php if ($GP['customers-index'] || $GP['customers-add'] || $GP['suppliers-index'] || $GP['suppliers-add']) { ?>
                                <li class="nav-parent mm_customers  mm_suppliers mm_billers">
                                    <a class="" href="#">
                                        <i class="fa fa-users"></i>
          ...
          <li>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href="<?= admin_url('Auth/create_card/' . $this->session->userdata('user_id')); ?>"><i class="fa fa-file-photo-o"></i> <?= lang('สร้างบัตรตัวแทน'); ?></a></li>
                <!-- <?php if($this->Settings->award_use){ ?>
                <li><a href="<?= admin_url('Auth/awardpoints/' . $this->session->userdata('user_id')); ?>"><i class="fa fa-heart"></i>
                 <?= lang('point'); ?></a></li> -->
                <?php } ?>
