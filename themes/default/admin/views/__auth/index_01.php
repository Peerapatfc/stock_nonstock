        ...
        oTable = $('#UsrTable').dataTable({
			...
			'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				if(aData[9] == "waiting_approve"){
					...
					$('td:eq(8)', nRow).html('<span class="label label-danger">'+txt+'</span>');
				}else if(aData[9] == "approve"){
					var txt = "<?php echo lang('approve'); ?>";
					$('td:eq(8)', nRow).html('<span class="label label-success">'+txt+'</span>');
				}else{
					$('td:eq(8)', nRow).html('');
				}
                ...
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,  null, {"bVisible": false}, null, {"mRender": user_status},null, null,{"bSortable": false}]
