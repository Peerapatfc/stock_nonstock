...
<body class="login-page">
            ...
            <div class=" container">
                <div class="login-form-div">
					<div class="login-header">
						<h3 class="sign_in"><?= lang('sign_in') ?></h3>
					</div>
                    <div class="login-content">
                        ...
                        <div class="form-action col-sm-12">
							...
							<div class="forgot_password pull-right">
								<h4 class="text-danger"><a href="#forgot_password" class="text-danger forgot_password_link"><?= lang('forgot_your_password') ?></a></h4>
							</div>
							
							<div class="clearfix"></div>
							<button style="background-color:#1caf9a; color:#fff" type="submit" class="btn-login btn  pull-right"><?= lang('login') ?> &nbsp; <i class="fa fa-sign-in"></i></button>
						</div>
                        <?php echo form_close(); ?>
                        <div class="clearfix"></div>
                    </div>
					<p class="legal">© 2017 All Rights Reserved. Proudly created with <a title="smith ระบบตัวแทน" href="https://www.atcreative.co.th/smith/" target="__blank"><?php echo '<img style="width: 16px;" src="' . base_url('assets/images/copyright_while.png'). '" />'; ?></a></p>
                    ...
                    <div class="login-content">
                        ...
                        <div class="col-sm-12">
                            <p style="color:#ff5555">
                                **<?= lang('email_address_or_phone_number'); ?>**
                            </p>
                            <div class="textbox-wrap form-group">
                                <div class="input-group">
                                    <span class="input-group-addon "><i class="fa fa-unlock-alt"></i></span>
                                    <input type="text" name="forgot_email" class="form-control "
                                    placeholder="<?= lang('email_or_phone') ?>" required="required"/>
                                </div>
                            </div>
                            <div class="form-action">
                                ...
                                <button type="submit" class="btn btn-primary pull-right">
                                    <?= lang('submit') ?> &nbsp;&nbsp; <i class="fa fa-unlock-alt"></i>
                                </button>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$("form.login input.form-control").focusin(function(){
				$(this).parents(".form-group").addClass("active");
				//$(this).parents(".form-group").removeClass("has-error");
				
			});
			$("form.login input.form-control").focusout(function(){
