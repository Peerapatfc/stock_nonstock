        ...
        oTable = $('#UsrTable').dataTable({
			...
			'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				if(aData[8] == "1"){
					...
					$('td:eq(7)', nRow).html('<span class="label label-success">'+txt+'</span>');
				}else{
					$('td:eq(7)', nRow).html('');
				}
				...
				if(aData[9] == "waiting_approve"){
					...
					$('td:eq(8)', nRow).css({"text-align":"center"}).html('<span class="text-danger"><i class="fa fa-times" aria-hidden="true"></i> '+txt+'</span>');
				}else if(aData[9] == "approve"){
					var txt = "<?php echo lang('approved_successfully'); ?>";
					$('td:eq(8)', nRow).css({"text-align":"center"}).html('<span class="text-success"><i class="fa fa-check" aria-hidden="true"></i> '+txt+'</span>');
				}else{
					//$('td:eq(8)', nRow).html('');
				}
                ...
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null,  null, {"bVisible": false}, null, {"mRender": user_status},null,{"bVisible": false},null,null]
