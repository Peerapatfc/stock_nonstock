															...
															<div class="panel-body" style="padding: 5px;">
																...
																<div class="form-group">
																	...
																	<?php
																		...
																		?>
																			<input name="<?php echo $sst['id']; ?>" type="checkbox" id="<?php echo $sst['code']; ?>" value="1" checked="checked" style="display:inline-block;" />
																			<label for="<?php echo $sst['code']; ?>" class="padding05"><?= lang($sst['name']); ?></label>
																		<?php
																	...
																	?>
																	<?php // form_label('Brands: ', 'tag_targets', $label_attr);?>
																	<div class="controls">
																	<?= form_multiselect('brand_targets[]',$brands,'','id="brand-select"');?>
																	</div>
																	</div>
																</div>
																</div>
