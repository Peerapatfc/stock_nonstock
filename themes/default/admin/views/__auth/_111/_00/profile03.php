            ...
            <div id="awardpoints" class="tab-pane fade in">
                <div class="box">
                    <div class="box-header">
                        <h2 class="blue"><i class="fa fa-gift" aria-hidden="true"></i><?= lang('award_points'); ?></h2>
                    </div>
												...
												<div class="panel-body">
													<div class="row">
														<div class="col-xs-12 col-sm-12">
															<input type="radio" class="checkbox type" value="1" name="agent" id="Non_stock" <?= $agent=='1' ? 'checked="checked"' : ''; ?> required="required">
