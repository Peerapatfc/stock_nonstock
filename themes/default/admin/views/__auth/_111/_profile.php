    ...
    <div class="col-sm-2">
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p><i class="glyphicon glyphicon-check"></i> <?php echo $user->seller_id; ?></p>
				<p><i class="glyphicon glyphicon-link"></i> <a href="<?php echo base_url('profile/'.$user->seller_id.'');?>" target="blank"><?php echo lang('agent_link');?></a></p>
...
<?php endif; ?>
				...
				//}
			?>
			<?php if($privilege->name):?><p><i class="fa fa-gift" aria-hidden="true"></i> <?php echo $privilege->name;?></p><?php endif;?>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group1">
												<?php echo lang('profile_picture', 'profile_picture'); ?>
												<input id="id_card"  type="file" data-browse-label="<?= lang('browse'); ?>" name="avatar" data-show-upload="false"
									...
									<?php } ?>
										...
										?>
                                        <div class="col-md-6 col-md-offset-1" <?php echo $display; ?>>
                                            <?php //if ($Owner && $id != $this->session->userdata('user_id')) { ?>
