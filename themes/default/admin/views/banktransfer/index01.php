                ...
                <div class="table-responsive">
                    <table id="BTFTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width: 170px;"><?php echo lang('account_name')?></th>
                            <th style="width: 170px;"><?php echo lang("account_number"); ?></th>
                            <th style="width: 170px;"><?php echo lang("nickname"); ?></th>
                            <th style="width:90px;"><?php echo $this->lang->line("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
