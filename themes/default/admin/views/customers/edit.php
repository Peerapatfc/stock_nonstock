...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
            ...
            <div class="row">
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_textarea('address', $customer->address, ' class="form-control" id="address" required="required"'); ?>
                    </div>
					</div>
                    ...
                    <div class="form-group">
                        <?= lang("line", "line"); ?>
                        <?php echo form_input('line', $customer->line, 'class="form-control" id="line"'); ?>
                    </div>
					</div>	
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_customer', lang('save_customer'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
