        ...
        <div class="modal-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
                    ...
                    <tr>
                        <td><strong><?= lang("line"); ?></strong></td>
                        <td><?= $customer->line; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("facebook"); ?></strong></td>
                        <td><?= $customer->facebook; ?></strong></td>
                    </tr>
            ...
            <div class="modal-footer no-print">
                ...
                <?php if ($Owner || $Admin || $GP['reports-customers']) { ?>
                    <a href="<?=admin_url('reports/customer_report/'.$customer->id);?>" target="_blank" class="btn btn-success"><?= lang('customers_report'); ?></a>
                <?php } ?>
                <?php if ($Owner || $Admin || $GP['customers-edit']) { ?>
                    <a href="<?=admin_url('customers/edit/'.$customer->id);?>" data-toggle="modal" data-target="#myModal2" class="btn btn-success"><?= lang('edit_customer'); ?></a>
                <?php } ?>
            </div>
