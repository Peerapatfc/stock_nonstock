...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="">
                    ...
                    <div class="col-md-12"><input style="float: left;" type="checkbox" class="checkbox" name="more" id="more"><label for="more" class="padding05"><?= lang('more_information'); ?></label></div>
					<div class="" id="more-con" style="display:none;">
						<div class="col-md-12">
						<div class="form-group">
							<?= lang("vat_no", "vat_no"); ?>
						...
						<div class="form-group">
							...
							<?php echo form_input('email', '', 'class="form-control" id="email_address" '); ?>
                    ...
                    <div class="form-group">
                        <?= lang("city", "city"); ?>
                        <?php echo form_input('city', 'city', 'class="form-control" id="city"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("state", "state"); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_customer', lang('add_customer'), 'class="btn btn-success"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
