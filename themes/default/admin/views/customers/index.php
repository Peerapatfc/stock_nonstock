...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            {column_number: 9, filter_default_label: "[<?=lang('points');?>]", filter_type: "text", data: []},
        ], "footer");
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th style="min-width:200px;"><?= lang("company"); ?></th>
                            <th style="min-width:200px;"><?= lang("name"); ?></th>
                            <th style="min-width:200px;"><?= lang("email_address"); ?></th>
                            <th style="min-width:150px;"><?= lang("phone"); ?></th>
                            <th style="min-width:150px;"><?= lang("price_group"); ?></th>
                            <th style="min-width:150px;"><?= lang("customer_group"); ?></th>
                            <th style="min-width:200px;"><?= lang("vat_no"); ?></th>
                            <th style="min-width:100px;"><?= lang("deposit"); ?></th>
                            <th style="min-width:140px;"><?= lang("points"); ?></th>
