...
<div class="box">
	...
	.pageheader .icon::before {
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('add_transfer'); ?></h2>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <div style="margin:10px 0" class="panel panel-warning">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                class="from-group"><?php echo form_submit('add_transfer', $this->lang->line("submit"), 'id="add_transfer" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
