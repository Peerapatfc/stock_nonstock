...
<div class="box">
	...
	.pageheader .icon::before {
        ...
        <h2 class="blue"><i class="fa-fw fa fa-plus-circle"></i><?= lang('transfer_by_csv'); ?></h2>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                class="from-group"><?php echo form_submit('add_transfer', $this->lang->line("submit"), 'id="add_transfer" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?></div>
                        </div>
