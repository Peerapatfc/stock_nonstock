...
<div class="box">
	...
	.pageheader .icon::before {
        ...
        <h2 class="blue"><i class="fa-fw fa fa-list"></i><?= lang('transfers'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="TOData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th><?= lang("date"); ?></th>
                            <th style="min-width:180px"><?= lang("ref_no"); ?></th>
                            <th style="min-width:180px"><?= lang("warehouse") . ' (' . lang('from') . ')'; ?></th>
                            <th style="min-width:180px"><?= lang("warehouse") . ' (' . lang('to') . ')'; ?></th>
                            <th style="min-width:180px"><?= lang("total"); ?></th>
                            <th style="min-width:180px"><?= lang("product_tax"); ?></th>
                            <th style="min-width:180px"><?= lang("grand_total"); ?></th>
                            <th style="min-width:180px"><?= lang("status"); ?></th>
