...
class Auth_model extends CI_Model
{
	...
	public function getProfilebyPhone($seller_id) {
        $this->db->select('companies.*, users.avatar, users.parent_id as parent_id, users.privilege_id as privilege_id, users.team as team, users.img as img, users.user_type as user_type')
