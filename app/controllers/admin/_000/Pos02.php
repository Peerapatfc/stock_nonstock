...
class Pos extends MY_Controller
{
    ...
    public function getSales($warehouse_id = NULL)
    {
        ...
        if ($warehouse_id) {
            $this->datatables
                ->select($this->db->dbprefix('sales') . ".id as id, sales.date, sales.reference_no, sales.biller, sales.customer, grand_total, paid, (grand_total-paid) as balance, sales.sale_status, sales.payment_status, companies.email as cemail")
				->from('sales')
