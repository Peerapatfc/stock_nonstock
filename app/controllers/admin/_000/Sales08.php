...
// echo json_encode($results);
    ...
    public function add_payment($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
			...
			$this->sales_model->addPoint($getSaleByID);
