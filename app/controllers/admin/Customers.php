...
class Customers extends MY_Controller
{
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('phone', lang("phone"), 'required|min_length[2]');
        if ($this->form_validation->run('companies/add') == true) {
            ...
            $line 		= $this->input->post('line') ? $this->input->post('line') : NULL;
    ...
    function suggestions($term = NULL, $limit = NULL)
    {
        ...
        $rows['results'] = $this->companies_model->getCustomerSuggestions($term, $limit, $user_id);
