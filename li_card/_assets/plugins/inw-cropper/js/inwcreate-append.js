             ...
             '<div class="modal-dialog">'
                 +'<div class="modal-content"> '
                   + '<div class="modal-header">'
                     ...
                     + '<h4 class="modal-title"><i class="fa fa-cloud-upload"></i> อัพโหลดรูปภาพ</h4>'
                   + '</div>'
                          ...
                          + '<div class="crop-btn-action po">' 
                               +'<form class="avatar-form" id="avatarForm" action="img-crop-v16.0.2.php" enctype="multipart/form-data" method="post">'
                                     +'<div class="crop-btn-style1">'
                                        +'<p><i class="fa fa-info-circle"></i> ขนาดรูปภาพสูงสุด <span class="model-info-txt"></span> Pixels.</p>'
                                     +'</div>'
                                     +'<div class="crop-btn-style3">'
                                        +'<button type="button" class="btn-close" id="btn-close-window" data-dismiss="modal"><i class="fa fa-remove"></i><span>ออก</span></button>'
                                     +'</div>'
                                     +'<div class="crop-btn-style3">'
                                        +'<button type="button" class="btn-clear" id="btn-clear"><i class="fa fa-refresh"></i><span>รีเซ็ต</span></button>'
                                     +'</div>'
                                     +'<div class="crop-btn-style3">'
                                        +'<button type="button" class="btn buton-disable btn-info" id="saveCropImg" disabled="disabled"><i class="fa fa-picture-o"></i><span>ยืนยันอัพโหลด</span></button>'
                                     +'</div>'
                                     +'<div class="crop-btn-style2">'
                                        +'<button class="btn-addfile" id="btn-addfile" type="button"><i class="fa fa-plus"></i><span>เพิ่ม </span></button>'
                                     +'</div>'
                                    +'<div class="clearfix"></div>'
                                    +'<div class="zone-img-crop clearfix">'
                                       +'<div class="col-md-8">'
                                          +'<div class="crop-img">'
                                              +'<img src="http://127.0.0.1/new-agent-card/assets/images/icon-add-image.png" id="imgViewTmp" >'
                                          +'</div>'
                                       +'</div>'
                                       +'<div class="col-md-4 add-border">'
                                          +'<div class="previewImg">'
                                              +'<img src="http://127.0.0.1/new-agent-card/assets/images/none-img.png" id="imgViewTmp" >'
                                          +'</div>'
