...
//          echo json_encode($type);die();
    ...
    $src = 'assets/images/imgup/tmp/' . date('YmdHis') . '.original' . $extension; 
...
//     /$this -> msg =" testttt : ".$file['error'];
  ...
  $this -> dst = 'assets/images/imgup/tmp/' . date('YmdHis') . '.jpg';
  }
...
//  echo $_POST['avatar_src']. " ". $_POST['avatar_data']. " ".$_FILES['avatar_file'];die();
// print_t($_POST);die;
...
$response = array(
 ...
 /* ==== code for delete image original ==== */
  ...
  $pathFile = $_SERVER['DOCUMENT_ROOT']."/agent-card/assets/images/imgup/tmp/".$fileDel;
  unlink($pathFile);
