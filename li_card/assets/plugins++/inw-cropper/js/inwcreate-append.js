                          ...
                          + '<div class="crop-btn-action po">' 
                               +'<form class="avatar-form" id="avatarForm" action="img-crop-v16.0.2.php" enctype="multipart/form-data" method="post">'
                                    ...
                                    +'<div class="zone-img-crop clearfix">'
                                       +'<div class="col-md-8">'
                                          +'<div class="crop-img">'
                                              +'<img src="assets/images/icon-add-image.png" id="imgViewTmp" >'
                                          +'</div>'
                                       +'</div>'
                                       +'<div class="col-md-4 add-border">'
                                          +'<div class="previewImg">'
                                              +'<img src="assets/images/none-img.png" id="imgViewTmp" >'
                                          +'</div>'
                                   ...
                                   +'<div class="data-view">'
                                      +'<div class="col-md-8">'
                                         ...
                                         +'</div>'
                                           ...
                                           +'<input class="avatar-input" id="inputImage" name="avatar_file" type="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff">'
